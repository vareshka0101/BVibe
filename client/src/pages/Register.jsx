              ...
              >
                ...
                <div className="text-center mb-4">
                  <div
                    ...
                    style={{
                      background: "linear-gradient(135deg, #0f9352, #007086)",
                      boxShadow: "0 10px 20px rgba(0, 112, 134, 0.2)",
                    }}
                  >
                    <svg
                      width="48"
                  ...
                  <h2 className="fw-bold" style={{ color: "#0f9352" }}>
                    Добро пожаловать!
                  </h2>
                  <p style={{ color: "#66b3cc" }}>Создайте свой аккаунт</p>
                </div>
                ...
                <form onSubmit={handleSubmit} autoComplete="off">
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      e.target.style.background =
                        "linear-gradient(135deg, #007086, #0f9352)";
                  ...
                  <div className="text-center">
                    <span style={{ color: "#66b3cc" }}>Уже есть аккаунт?</span>{" "}
                    <Link
                      to="/login"
                      className="text-decoration-none fw-semibold"
                      style={{ color: "#ed014b" }}
                      onMouseEnter={(e) => (e.target.style.color = "#f56800")}
                      onMouseLeave={(e) => (e.target.style.color = "#ed014b")}
                    >
                      Войти
                    </Link>
                  </div>
