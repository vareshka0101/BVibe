...
export default function Navbar() {
  ...
  // Ваша SVG иконка (оптимизированная под размер 28x28)
      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav ms-auto align-items-center">
            {user ? (
              <>
                {/* Иконка пользователя - та же иконка растяжки */}
                ...
                <li className="nav-item">
                  <button
                    className="btn px-4 py-2 border-0 rounded-pill fw-semibold"
              ...
              <>
                <li className="nav-item me-2">
                  <Link
                    ...
                    onMouseEnter={(e) => {
                      e.target.style.background = "#f56800";
                      e.target.style.transform = "scale(1.05)";
                      e.target.style.boxShadow =
                        "0 5px 15px rgba(245, 104, 0, 0.4)";
                    }}
                    onMouseLeave={(e) => {
